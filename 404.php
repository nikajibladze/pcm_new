    ...
    <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="col-lg-4 col-md-8 col-10 p-0">
            <div class="card-header bg-transparent border-0">
                ...
                <h3 class="text-uppercase text-center">გვერდი არ მოიძებნა</h3>
            </div>
            <div class="card-content">
              
                <div class="row py-2 justify-content-center">
                    <div class="col-12 col-sm-6 col-md-6 mb-1">
                        <a href="index.php" class="btn btn-primary btn-block"><i class="fa fa-home"></i>  მთავარი</a>
                    </div>
            ...
            <div class="card-footer bg-transparent">
                <div class="row">
                    <p class="text-muted text-center col-12 py-1">© <span class="year"></span> <a href="#">MEDICAL </a>MOD  <a href="" target="_blank">IT</a></p>
